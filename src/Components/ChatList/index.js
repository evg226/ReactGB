...
import { addChat,deleteChat,addMessage } from "../../Store/actions";
...
function ChatList({ chatId }) {
    ...
    const addNewMessage = useCallback((newMessage) => {
        dispatch(addMessage(activeUser.id,chatId,newMessage));
    ...
    // }, [chats,chatId,addNewMessage]); //c данными параметрами при переключении на другой чат "подвисает" ответ робота
